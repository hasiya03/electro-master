        ...
        <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="images/Evil Imp Dolch Keycap Set Mechanical Keyboard (152) MX Switch Cherry Profile Double Shot with Keycap Puller.jpg" class="d-block w-100" alt="...">
                ...
                <div class="carousel-item">
                    <img src="images/Lotus Flower Theme KeyCap Set, OEM Profile PBT Subdye Keycap, Ink Painting Theme Gaming Mechanical Keyboard Keycap, Black Artisan Keycaps.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption  d-md-block">
                        <h5>First slide label</h5>
                        <p>Some representative placeholder content for the first slide.</p>
                    </div>
                ...
                <div class="carousel-item">
                    <img src="images/The best tech of CES 2015_ Our picks.jpg" class="d-block w-100" alt="...">
                    <div class="carousel-caption  d-md-block">
                        <h5>First slide label</h5>
                        <p>Some representative placeholder content for the first slide.</p>
                    </div>
